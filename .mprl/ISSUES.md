...
- [ ] [M001] (P0) Analyze current code against AGENTS.FRONTEND.md guidance and POLICY.md and prepare a refactoring plan.
  Analyze current code against AGENTS.FRONTEND.md guidance and POLICY.md and prepare a refactoring plan
