...
- Set admin allowlists through `CROSSWORDAPI_ADMIN_EMAILS` in `.env.crosswordapi` or another server-side secret source.
...
- Keep `.env.crosswordapi`, `.env.tauth`, and any credential exports untracked.
